Shader"Custom/Specular_Blinn_Phong"{
    Properties{
    ...
    SubShader{
        pass{
            ...
            float4 frag(v2f f):SV_TARGET{
                ...
                float3 specularRate = pow(max(0,dot(halfDir,worldNormal)),_Gloss);
                float3 specular = _LightColor0.rgb * _Specular.rgb * specularRate;
